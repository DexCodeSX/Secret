...
async function cmdSnoop() {
  ...
  box([
    ...
    `     ${c.dim}sentry: o207216 / 4505703603830784${c.reset}`,
    `     ${c.dim}datadog: c9ba74e4...cfd8 / pub13cc1c08...${c.reset}`,
    ``,
    `${c.gold}4. tracking pixels everywhere${c.reset}`,
    `   ${c.dim}● Segment write key:  N2VehZC46evia2S5CiI8EE4m7JY04QVc${c.reset}`,
    `   ${c.dim}● Google Tag Manager: GTM-TKVWCH3V${c.reset}`,
